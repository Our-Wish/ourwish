              ...
              <div class="rounded-2xl border border-slate-200 bg-white/70 px-6 py-5">
                <div class="flex items-center gap-2">
                  <input
                    ...
                    type="text"
                    inputmode="numeric"
                    class="w-28 rounded-xl border border-slate-200 bg-white px-3 py-1.5 text-2xl font-extrabold text-slate-900 outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-100"
                  />
